...
BASEDIR="/app/data/data"
## Set directories for datasets
DATA_DIRS = {
    # "slakh2100": opj(BASEDIR, "slakh/slakh2100_flac_redux_wav/"),
    "musdb18hq": opj(BASEDIR, "musdb18hq/"),
...
def pre_encode(config):
    ...
    # 使用 cuda:0，因为 CUDA_VISIBLE_DEVICES 设置后，可见的 GPU 在 PyTorch 中的索引总是从 0 开始
